...
<!-- jQuery Validate -->
<script src="{{ asset('admin_assets/plugins/jquery-validate/jquery.validate.min.js') }}"></script>
<script src="{{ asset('admin_assets/plugins/jquery-validate/additional-methods.js') }}"></script>
<!-- Bootstrap 3.3.7 -->
